...
RSpec.describe 'Items API' do
  ...
  describe 'POST /todos/:todo_id/items/:id' do
    let(:valid_attributes) {{ name: 'Zenjutahi Luffy', done: false }.to_json }
  ...
  describe 'PUT /todos/:todo_id/items/:id' do
    ...
    context 'when item exits' do
      ...
      it 'updates the item' do
        ...
        expect(updated_item.name).to match(/Moarzat/)
      end
    end
